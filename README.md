# TrumpsFeedCrawler
This is a web application which pulls data from CNN and Twitter that are relevant to Donald Trump. You can try the application here: http://shuvo123456.azurewebsites.net/
